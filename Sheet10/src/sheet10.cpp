...
int main() {
    ...
    for (int i = 1; i < NUM_IMAGES; i++) {
        ...
        cv::cornerSubPix(img_gray, img_corners, cv::Size(11, 11), cv::Size(-1, -1),
    ...
    double reprojection_error_combined = cv::calibrateCamera(objectPoints, corners, img_size, cameraMatrix,
                                                             distortionMatrix, rotation_vectors, translation_vectors);
    ...
    std::cout << "reprojection_error_combined = " << reprojection_error_combined << std::endl;
